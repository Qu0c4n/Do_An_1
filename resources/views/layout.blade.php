...
<head>
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/t2.css')}}" rel="stylesheet">
...
<!-- #fffbf2 mau body -->
    ...
    <script src="{{asset('frontend/js/a.js')}}"></script>
    <script src="{{asset('frontend/js/b.js')}}"></script>
    <script src="{{asset('frontend/js/c.js')}}"></script>
    <script src="{{asset('frontend/js/i.js')}}"></script>
    <script src="{{asset('frontend/js/j1.js')}}"></script>
    <script src="{{asset('frontend/js/j2.js')}}"></script>
    <script src="{{asset('frontend/js/j3.js')}}"></script>
    <script src="{{asset('frontend/js/p.js')}}"></script>
    <script src="{{asset('frontend/js/s.js')}}"></script>
    <script src="{{asset('frontend/js/w.js')}}"></script>
