<section class="section" id="our-classes">
    ...
    margin-bottom: 1px;" class="section-heading">
                        ...
                        <img src="{{asset('frontend/images/l.png')}}" alt="">
            ...
            <div class="row" style="transform: translateY(78px);" id="tabs">
              ...
              <div class="col-lg-4">
                <ul>
                  <li><a style=" font-size: 12px; height: 100px;    padding: 11px 30px;" href='#tabs-1'><img  src="{{asset('frontend/images/ic4.jpg')}}" alt="">Thông tin ưu đãi</a></li>
                  <li><a style=" font-size: 12px; height: 100px;    padding: 11px 30px;" href='#tabs-2'><img src="{{asset('frontend/images/ic1.jpg')}}" alt="">Công đoạn chuẩn bị</a></a></li>
                  <li><a style=" font-size: 12px; height: 100px;    padding: 11px 30px;" href='#tabs-3'><img src="{{asset('frontend/images/ic7.jpg')}}" alt=""> Trải ngiệm của khách</a></a></li>
              ...
              <div class="col-lg-8">
                ...
                <article id='tabs-1'>
                    <img style="width:80%; height: 380px;" src="{{asset('frontend/images/cf4.jpg')}}" alt="Third Class">
                  ...
                  <article id='tabs-2'>
                    <img style="width:80%; height: 380px;" src="{{asset('frontend/images/cf1.jpg')}}" alt="First Class">
                  ...
                  <article id='tabs-3'>
                    <img style="width:80%; height: 380px;" src="{{asset('frontend/images/cf2.jpg')}}" alt="Second Training">
